...
namespace zookeeper { namespace rpc { namespace json {
    LoggerPtr MethodAdaptor::logger(Logger::getLogger("zookeeper.rpc.json.MethodAdaptor"));
    ...
    void MethodAdaptor::staticGlobalWatcher(zhandle_t *zkHandle, int type, int state, const char *path, void *context) {
        reinterpret_cast<MethodAdaptor *>(context)->globalWatcher(type, state, path);
    }
    ...
    JSONValue MethodAdaptor::invoke(const std::string &name, const JSONValue::JSONArray &param, StatePersistence *persistence) {
        if (name == "zoo_exists") {
    ...
    JSONValue::JSONBoolean MethodAdaptor::zooExists(JSONValue::JSONString path) {
        int ret;
        do {
    ...
    JSONValue::JSONString MethodAdaptor::zooGet(JSONValue::JSONString path) {
    ...
    JSONValue::JSONString MethodAdaptor::zooSet(JSONValue::JSONString path,
    ...
    JSONValue::JSONArray MethodAdaptor::zooGetChildren(JSONValue::JSONString path) {
